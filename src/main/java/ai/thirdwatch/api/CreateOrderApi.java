...
public class CreateOrderApi {
     ...
     * @param body An order to submit for review. Only &#x60;_userID&#x60; is required field. But this should contain order info. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call createOrderCall(CreateOrder body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createOrderValidateBeforeCall(CreateOrder body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public EventResponse createOrder(CreateOrder body) throws ApiException {
        ApiResponse<EventResponse> resp = createOrderWithHttpInfo(body);
        return resp.getData();
    }
    ...
    /**
     * Submit a new or existing order to Thirdwatch for review. This API should contain order item info, the payment info, and user identity info. (asynchronously)
     * 
     * @param body An order to submit for review. Only &#x60;_userID&#x60; is required field. But this should contain order info. (required)
     ...
     */
    public com.squareup.okhttp.Call createOrderAsync(CreateOrder body, final ApiCallback<EventResponse> callback) throws ApiException {
