...
import ai.thirdwatch.auth.Authentication;
import ai.thirdwatch.auth.HttpBasicAuth;
import ai.thirdwatch.auth.ApiKeyAuth;
import ai.thirdwatch.auth.OAuth;
...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        authentications.put("api_key", new ApiKeyAuth("header", "X-THIRDWATCH-API-KEY"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://localhost/event
